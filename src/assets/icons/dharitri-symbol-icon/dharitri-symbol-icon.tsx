...
@Component({
  tag: 'drt-dharitri-symbol-icon',
  styleUrl: 'dharitri-symbol-icon.scss',
  shadow: true,
})
export class DharitrISymbolIcon {
  @Prop() class?: string;
  ...
  render() {
    return (
      <svg
        ...
        class={{ 'dharitri-symbol-icon': true, [this.class]: Boolean(this.class) }}
      >
