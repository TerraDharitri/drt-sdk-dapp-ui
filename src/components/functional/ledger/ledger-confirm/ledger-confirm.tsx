    ...
    return (
      <div data-testid={DataTestIdsEnum.ledgerConfirmAddress} class="ledger-confirm">
            ...
            <div class="ledger-confirm-item">
              ...
              <div class="ledger-confirm-item-value">
                ...
                <div class="ledger-confirm-item-value-actions">
                  <drt-copy-button text={ledgerConfirmationItem.value} class="ledger-confirm-item-value-copy" iconClass="ledger-confirm-item-value-copy-icon" />

                  {ledgerConfirmationItem.explorerLink && (
                    <drt-explorer-link link={ledgerConfirmationItem.explorerLink} class="ledger-confirm-item-value-explorer" iconClass="ledger-confirm-item-value-explorer-icon" />
                  )}
                </div>
              </div>
            </div>
        ...
        <div class="ledger-confirm-footer">
          ...
          <a target="_blank" rel="noreferrer" href="https://help.dharitri.org/en/" class="ledger-confirm-footer-button">
            Contact Support
          </a>
        </div>
      </div>
