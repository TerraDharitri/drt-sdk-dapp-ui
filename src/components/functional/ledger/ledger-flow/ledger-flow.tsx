...
export class LedgerFlow {
  ...
  render() {
    const header = (
      <drt-side-panel-header panelTitle={providerLabels.ledger} hasRightButton={false} onLeftButtonClick={() => this.eventBus.publish(LedgerConnectEventsEnum.CLOSE)}>
    ...
    return (
      <Fragment>
        {header}
        <drt-ledger-intro connectScreenData={this.ledgerDataState.connectScreenData} onConnect={this.handleIntroConnect.bind(this)} />
      </Fragment>
    );
  }
}
