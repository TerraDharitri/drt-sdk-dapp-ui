  ...
  render() {
    ...
    return (
      <div
        ...
        id="toast-list"
      >
        {this.customToastsState?.map(toast => <drt-generic-toast toast={toast} onDeleteToast={this.handleCustomToastDelete.bind(this, toast.toastId)}></drt-generic-toast>)}
        {this.transactionToastsState?.map(toast => (
          <drt-transaction-toast {...toast} onDeleteToast={this.handleTransactionToastDelete.bind(this, toast.toastId)}></drt-transaction-toast>
        ))}
