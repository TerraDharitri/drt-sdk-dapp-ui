...
describe('DataWithExplorerLink', () => {
  it('renders with default props', async () => {
    const page = await newSpecPage({
      ...
      html: '<drt-data-with-explorer-link data="test-data" explorer-link="https://explorer.com/test"></drt-data-with-explorer-link>',
    });
    ...
    const trimComponent = page.root.querySelector('drt-trim.data-with-explorer-link-trim');
    ...
    const copyButton = page.root.querySelector('drt-copy-button');
  ...
  it('renders with custom class and dataTestId', async () => {
    const page = await newSpecPage({
      components: [DataWithExplorerLink, Trim, CopyButton, ExplorerLink],
      html: '<drt-data-with-explorer-link data="test-data" explorer-link="https://explorer.com/test" class="custom-class" data-test-id="custom-test-id"></drt-data-with-explorer-link>',
    });
  ...
  it('renders with copy button disabled', async () => {
    const page = await newSpecPage({
      ...
      html: '<drt-data-with-explorer-link data="test-data" explorer-link="https://explorer.com/test" show-copy-button="false"></drt-data-with-explorer-link>',
    });
  ...
  it('renders with explorer button disabled', async () => {
    const page = await newSpecPage({
      ...
      html: '<drt-data-with-explorer-link data="test-data" explorer-link="https://explorer.com/test" show-explorer-button="false"></drt-data-with-explorer-link>',
    });
  ...
  it('renders with both buttons disabled', async () => {
    const page = await newSpecPage({
      ...
      html: '<drt-data-with-explorer-link data="test-data" explorer-link="https://explorer.com/test" show-copy-button="false" show-explorer-button="false"></drt-data-with-explorer-link>',
    });
    ...
    const trimComponent = page.root.querySelector('drt-trim');
    expect(trimComponent).toBeTruthy();
  ...
  it('renders with tooltips enabled', async () => {
    const page = await newSpecPage({
      ...
      html: '<drt-data-with-explorer-link data="test-data" explorer-link="https://explorer.com/test" with-tooltip="true"></drt-data-with-explorer-link>',
    });
    ...
    const tooltips = page.root.querySelectorAll('drt-tooltip');
  ...
  it('renders with tooltips enabled and copy button disabled', async () => {
    const page = await newSpecPage({
      ...
      html: '<drt-data-with-explorer-link data="test-data" explorer-link="https://explorer.com/test" with-tooltip="true" show-copy-button="false"></drt-data-with-explorer-link>',
    });
  ...
  it('renders with tooltips enabled and explorer button disabled', async () => {
    const page = await newSpecPage({
      ...
      html: '<drt-data-with-explorer-link data="test-data" explorer-link="https://explorer.com/test" with-tooltip="true" show-explorer-button="false"></drt-data-with-explorer-link>',
    });
  ...
  it('renders with empty data', async () => {
    const page = await newSpecPage({
      components: [DataWithExplorerLink, Trim, CopyButton, ExplorerLink],
      html: '<drt-data-with-explorer-link data="" explorer-link="https://explorer.com/test"></drt-data-with-explorer-link>',
    });
  ...
  it('renders with long data string', async () => {
    ...
    const page = await newSpecPage({
      components: [DataWithExplorerLink, Trim, CopyButton, ExplorerLink],
      html: `<drt-data-with-explorer-link data="${longData}" explorer-link="https://explorer.com/test"></drt-data-with-explorer-link>`,
    });
  ...
  it('has correct component properties set', async () => {
    const page = await newSpecPage({
      ...
      html: '<drt-data-with-explorer-link data="test-data" explorer-link="https://explorer.com/test" show-copy-button="false" show-explorer-button="true" with-tooltip="true" class="custom" data-test-id="test"></drt-data-with-explorer-link>',
    });
