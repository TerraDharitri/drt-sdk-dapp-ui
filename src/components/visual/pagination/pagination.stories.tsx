...
const storySettings: Meta<Pagination> = {
  ...
  render: properties => <drt-pagination {...properties} />,
  args: {
    currentPage: 1,
    totalPages: 10,
    isDisabled: false,
...
export const FirstPage: StoryObj<Pagination> = {
  render: () => <drt-pagination currentPage={1} totalPages={10} />,
};

export const LastPage: StoryObj<Pagination> = {
  render: () => <drt-pagination currentPage={10} totalPages={10} />,
};

export const SinglePage: StoryObj<Pagination> = {
  render: () => <drt-pagination currentPage={1} totalPages={1} />,
};

export const ManyPages: StoryObj<Pagination> = {
  render: () => <drt-pagination currentPage={520} totalPages={1000} />,
};
